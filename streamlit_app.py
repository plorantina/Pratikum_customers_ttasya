...
st.subheader("Tambahakan Chart Lainnya Versi Anda Sendiri!")
st.write("Untuk menambahkan chart lihat dan pahami struktur tabel data set file customers.csv")

st.subheader("AREA CHART")
st.write(
    "Area chart ini menampilkan rata-rata gaji tahunan (AnnualSalary) "
    "berdasarkan usia pelanggan untuk melihat tren kenaikan atau penurunan gaji."
)
salary_age_area = (
    df_filtered
    .groupby("Age")["AnnualSalary"]
